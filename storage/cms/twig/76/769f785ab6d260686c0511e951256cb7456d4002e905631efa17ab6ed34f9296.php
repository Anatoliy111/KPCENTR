...
/* D:\OpenServer\domains\KPCENTR/themes/rainlab-vanilla/layouts/default.htm */
class __TwigTemplate_6d6eda6be0dba58dfcb752d0ebae4c1dfbc6f370635a74e1ae63f6f2462b36be extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<html>
    ...
    <body>
        ...
        echo "\">Vanilla</a>
                    ...
                    <div class=\"collapse navbar-collapse navbar-main-collapse\">
                        <ul class=\"nav navbar-nav\">
                            <li class=\"";
        // line 35
        if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["this"] ?? null), "page", [], "any", false, false, true, 35), "id", [], "any", false, false, true, 35) == "account")) {
            echo "active";
        }
        echo "\"><a href=\"";
        ...
        echo "\">Account</a></li>
                            <li class=\"";
        // line 36
        if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["this"] ?? null), "page", [], "any", false, false, true, 36), "id", [], "any", false, false, true, 36) == "blog")) {
            echo "active";
        }
        echo "\"><a href=\"";
        ...
        echo "\">Blog</a></li>
                            <li class=\"";
        // line 37
        if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["this"] ?? null), "page", [], "any", false, false, true, 37), "id", [], "any", false, false, true, 37) == "forum")) {
            echo "active";
        }
        echo "\"><a href=\"";
        ...
        // line 54
        echo $this->extensions['Cms\Twig\Extension']->themeFilter((("assets/images/textures/" . $this->sandbox->ensureToStringAllowed(($context["jumbotronTexture"] ?? null), 54, $this->source)) . ".png"));
        echo ")\">
                <div class=\"container\">
                    <h1>";
        // line 56
        echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["this"] ?? null), "page", [], "any", false, false, true, 56), "title", [], "any", false, false, true, 56), 56, $this->source), "html", null, true);
        echo "</h1>
                    <p>";
        // line 57
        echo twig_escape_filter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["this"] ?? null), "page", [], "any", false, false, true, 57), "description", [], "any", false, false, true, 57), 57, $this->source), "html", null, true);
        echo "</p>
                </div>
            </div>
            <div class=\"container\">
    ...
    {
        return "D:\\OpenServer\\domains\\KPCENTR/themes/rainlab-vanilla/layouts/default.htm";
    }
    ...
    {
        return array (  197 => 89,  193 => 88,  182 => 87,  179 => 86,  177 => 71,  172 => 68,  168 => 67,  161 => 62,  159 => 61,  152 => 57,  148 => 56,  143 => 54,  138 => 51,  136 => 50,  127 => 43,  123 => 41,  121 => 40,  111 => 37,  103 => 36,  95 => 35,  88 => 31,  69 => 14,  66 => 12,  63 => 11,  59 => 10,  53 => 7,  49 => 6,  45 => 5,  39 => 1,);
    }
...
</html>", "D:\\OpenServer\\domains\\KPCENTR/themes/rainlab-vanilla/layouts/default.htm", "");
    }
    
    public function checkSecurity()
    {
        static $tags = array("styles" => 11, "if" => 35, "set" => 50, "page" => 61, "partial" => 67, "framework" => 87, "scripts" => 88);
        static $filters = array("escape" => 5, "theme" => 10, "page" => 31);
        static $functions = array("random" => 50);

        try {
            $this->sandbox->checkSecurity(
                ['styles', 'if', 'set', 'page', 'partial', 'framework', 'scripts'],
                ['escape', 'theme', 'page'],
                ['random']
            );
